...
#define PROGRAM_NAME		"Pigeoncoin Miner"
...
int main(int argc, char *argv[])
{
	...
	printf("*** Pigeoncoin Miner " PACKAGE_VERSION " for nVidia GPUs ***\n");
	if (!opt_quiet) {
	...
	if (dev_donate_percent == 0.0) {
		...
		printf("PGN donation address: PN7CLWzxzsDNWrbrEhLkFKHaKVUbg2UGM5\n\n");
	}
	else {
		// Set dev pool credentials.
		rpc_user = strdup("PN7CLWzxzsDNWrbrEhLkFKHaKVUbg2UGM5");
		rpc_pass = strdup("donate,c=PGN");
		rpc_url = strdup("stratum+tcp://blockcruncher.com:3636");
